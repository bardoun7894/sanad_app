...
class _AdminSettingsScreenState extends ConsumerState<AdminSettingsScreen> {
  ...
  Future<void> _saveSetting(String key, dynamic value) async {
    ...
    try {
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('${s.errorSavingSetting}: $e')));
      }
    } finally {
      if (mounted) setState(() => _isLoading = false);
    }
        ...
        children: [
          ...
          Expanded(
            child: ListView(
              padding: pagePadding,
              children: [
                _buildSectionTitle(s.systemStatus, textColor),
                ...
                _buildSwitchTile(
                  ...
                  onChanged: (val) {
                    ...
                    _saveSetting('maintenance_mode', val);
                  },
                ),
  ...
  Future<void> _editStringSetting(
    ...
    if (result != null && result.isNotEmpty && result != currentValue) {
      if (dbKey == 'min_app_version') {
        setState(() => _minAppVersion = result);
      } else if (dbKey == 'contact_email') {
